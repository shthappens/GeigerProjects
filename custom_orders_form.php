...
// Required to prevent complaints from PHP when using mail() function
    ...
    if(isset($_POST['form'])){
        ...
        if($obj->location == 'Alaska'|| $obj->location == 'Alabama'|| $obj->location == 'Arizona'|| $obj->location == 'California'|| $obj->location == 'Florida'|| $obj->location == 'Georgia'|| $obj->location == 'Louisiana'|| $obj->location == 'North Carolina'|| $obj->location == 'Nevada'|| $obj->location == 'Oklahoma'|| $obj->location == 'Oregon'|| $obj->location == 'South Carolina'|| $obj->location == 'Texas'|| $obj->location == 'Utah') {
            $emailto = 'cpweb@geiger.com, seth.h.thompson@gmail.com';
        } 
        else {
